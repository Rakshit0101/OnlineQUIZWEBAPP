...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1"%>
            <%@page import="qwa.model.Question_db"%>
...
ArrayList<Questions> allQuestions = Question_db.getAllRecords();
int i = 0;
...
<center>
<input  onclick="location.href='qwa.validation.LogoutStudent'" type="button" value="Exit" class="btn btn-outline-danger btn-lg">
</center>
