...
<%@page import="qwa.model.Student_db"%>
...
<body>
 ...
 <%
   String name = Student_db.getStudentName(session.getAttribute("username").toString());
%> 
...
<%
   int i = 1;
   ArrayList<Instructions> allinsts = Instruction_db.getAllRecords();
